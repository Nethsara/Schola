...
public class ExamQuestions implements SuperEntity {
    ...
    public ExamQuestions(int questionNo, String exmID,
                         String question, String mcq1, String mcq2, String mcq3, String mcq4, int correctAns) {
